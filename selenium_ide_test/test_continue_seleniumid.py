...
class Test_Testcontinue():
  ...
  def test_testcontinue(self):
    ...
    self.driver.find_element(By.CSS_SELECTOR, "*[data-test=\"firstName\"]").send_keys("Dogukan ")
    self.driver.find_element(By.ID, "last-name").click()
    self.driver.find_element(By.CSS_SELECTOR, "*[data-test=\"lastName\"]").send_keys("Mutlu")
